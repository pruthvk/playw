...
=========================== logs ===========================
waiting for navigation to "/web/index.php/dashboard" until "load"
          ...
          - generic [ref=e294]:
            - generic [ref=e295] [cursor=pointer]:
              ...
              - generic [ref=e298]:
                ...
                - paragraph [ref=e300]: 2026-28-04 02:48 PM
            - separator [ref=e301]
            - img [ref=e302]
      - generic [ref=e304]:
        - generic [ref=e305]:
      ...
      - generic [ref=e318]:
        ...
        - list [ref=e328]:
          - listitem [ref=e329] [cursor=pointer]:
            - generic "Human Resource Department" [ref=e331]
          - listitem [ref=e332] [cursor=pointer]:
            - generic "Operational Department" [ref=e334]
      ...
      - generic [ref=e339]:
        ...
        - list [ref=e349]:
          ...
          - listitem [ref=e356] [cursor=pointer]:
            - generic "01_Auto Test Location_1777366738384" [ref=e358]
...
```ts
  ...
  12 | 
> 13 |     await page.waitForURL('/web/index.php/dashboard')
     |                ^ Error: page.waitForURL: Target page, context or browser has been closed
  14 | 
